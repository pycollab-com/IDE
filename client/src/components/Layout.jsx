    ...
    <div className={`app-shell ${sidebarOpen ? "sidebar-open" : "sidebar-collapsed"}`}>
      <aside className={`app-sidebar ${sidebarOpen ? "open" : "closed"}`}>
        ...
        <div className="sidebar-footer">
          ...
          >
            <div className="user-avatar">
              {user?.profile_picture_path ? (
                <img src={user.profile_picture_path.startsWith("http") || user.profile_picture_path.startsWith("data:") ? user.profile_picture_path : `${API_BASE}${user.profile_picture_path}`} alt="avatar" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              ) : (
          ...
          {(user?.impersonated_at || localStorage.getItem("impersonator_token")) && (
            <motion.div
